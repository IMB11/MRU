...
/**
 * See BlockItemTags for vanilla tags.
 * Note that addition to some vanilla tags implies having certain functionality.
 */
public final class CommonBlockItemTags {
	private CommonBlockItemTags() {
	}
	 ...
	 */
	public static final BlockItemTagId SKULLS = register(CommonUtils.blockTag("c","skulls"), ItemTags.SKULLS);
	//?}
	...
	private static BlockItemTagId register(String tagId) {
		Identifier id = CommonUtils.id("c", tagId);
