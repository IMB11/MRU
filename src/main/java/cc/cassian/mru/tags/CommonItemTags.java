...
public final class CommonItemTags {
	 ...
	 */
	public static final TagKey<Item> STONES = CommonBlockItemTags.STONES.item();
	public static final TagKey<Item> COBBLESTONES = CommonBlockItemTags.COBBLESTONES.item();
	public static final TagKey<Item> DEEPSLATE_COBBLESTONES = CommonBlockItemTags.DEEPSLATE_COBBLESTONES.item();
	public static final TagKey<Item> INFESTED_COBBLESTONES = CommonBlockItemTags.INFESTED_COBBLESTONES.item();
	public static final TagKey<Item> MOSSY_COBBLESTONES = CommonBlockItemTags.MOSSY_COBBLESTONES.item();
	public static final TagKey<Item> NORMAL_COBBLESTONES = CommonBlockItemTags.NORMAL_COBBLESTONES.item();
	public static final TagKey<Item> NETHERRACKS = CommonBlockItemTags.NETHERRACKS.item();
	public static final TagKey<Item> END_STONES = CommonBlockItemTags.END_STONES.item();
	public static final TagKey<Item> GRAVELS = CommonBlockItemTags.GRAVELS.item();
	public static final TagKey<Item> OBSIDIANS = CommonBlockItemTags.OBSIDIANS.item();
	/**
	 ...
	 */
	public static final TagKey<Item> NORMAL_OBSIDIANS = CommonBlockItemTags.NORMAL_OBSIDIANS.item();
	public static final TagKey<Item> CRYING_OBSIDIANS = CommonBlockItemTags.CRYING_OBSIDIANS.item();
	/// Light-emitting blocks created when a Frog eats a Magma Cube.
	public static final TagKey<Item> FROGLIGHTS = CommonBlockItemTags.FROGLIGHTS.item();
	...
	// Armor tags
	/**
	 * A tag containing all Common armor tags.
	 * Note that this can contain armor that does not necessarily fit on a player. For that, see {@link CommonItemTags#HUMANOID_ARMORS}
	 */
	...
	public static final TagKey<Item> ORES = CommonBlockItemTags.ORES.item();
	...
	public static final TagKey<Item> COAL_ORES = CommonBlockItemTags.COAL_ORES.item();
	public static final TagKey<Item> COPPER_ORES = CommonBlockItemTags.COPPER_ORES.item();
	public static final TagKey<Item> DIAMOND_ORES = CommonBlockItemTags.DIAMOND_ORES.item();
	public static final TagKey<Item> EMERALD_ORES = CommonBlockItemTags.EMERALD_ORES.item();
	public static final TagKey<Item> GOLD_ORES = CommonBlockItemTags.GOLD_ORES.item();
	public static final TagKey<Item> IRON_ORES = CommonBlockItemTags.IRON_ORES.item();
	public static final TagKey<Item> LAPIS_ORES = CommonBlockItemTags.LAPIS_ORES.item();
	public static final TagKey<Item> NETHERITE_SCRAP_ORES = CommonBlockItemTags.NETHERITE_SCRAP_ORES.item();
	public static final TagKey<Item> QUARTZ_ORES = CommonBlockItemTags.QUARTZ_ORES.item();
	public static final TagKey<Item> REDSTONE_ORES = CommonBlockItemTags.REDSTONE_ORES.item();
	...
	public static final TagKey<Item> BARRELS = CommonBlockItemTags.BARRELS.item();
	public static final TagKey<Item> WOODEN_BARRELS = CommonBlockItemTags.WOODEN_BARRELS.item();
	public static final TagKey<Item> BOOKSHELVES = CommonBlockItemTags.BOOKSHELVES.item();
	public static final TagKey<Item> CHESTS = CommonBlockItemTags.CHESTS.item();
	public static final TagKey<Item> WOODEN_CHESTS = CommonBlockItemTags.WOODEN_CHESTS.item();
	public static final TagKey<Item> TRAPPED_CHESTS = CommonBlockItemTags.TRAPPED_CHESTS.item();
	public static final TagKey<Item> ENDER_CHESTS = CommonBlockItemTags.ENDER_CHESTS.item();
	public static final TagKey<Item> GLASS_BLOCKS = CommonBlockItemTags.GLASS_BLOCKS.item();
	public static final TagKey<Item> GLASS_BLOCKS_COLORLESS = CommonBlockItemTags.GLASS_BLOCKS_COLORLESS.item();
	/**
	 * Glass which is made from cheap resources like sand and only minor additional ingredients like dyes.
	 */
	public static final TagKey<Item> GLASS_BLOCKS_CHEAP = CommonBlockItemTags.GLASS_BLOCKS_CHEAP.item();
	public static final TagKey<Item> GLASS_BLOCKS_TINTED = CommonBlockItemTags.GLASS_BLOCKS_TINTED.item();
	public static final TagKey<Item> GLASS_PANES = CommonBlockItemTags.GLASS_PANES.item();
	public static final TagKey<Item> GLASS_PANES_COLORLESS = CommonBlockItemTags.GLASS_PANES_COLORLESS.item();
	/**
	 * Block tag equivalent is {@link BlockTags#SHULKER_BOXES}.
	 */
	public static final TagKey<Item> SHULKER_BOXES = register("shulker_boxes");
	public static final TagKey<Item> GLAZED_TERRACOTTAS = CommonBlockItemTags.GLAZED_TERRACOTTAS.item();
	public static final TagKey<Item> CONCRETES = CommonBlockItemTags.CONCRETES.item();
	public static final TagKey<Item> CONCRETE_POWDERS = register("concrete_powders");

	// Related to budding mechanics
	public static final TagKey<Item> BUDDING_BLOCKS = CommonBlockItemTags.BUDDING_BLOCKS.item();
	public static final TagKey<Item> BUDS = CommonBlockItemTags.BUDS.item();
	public static final TagKey<Item> CLUSTERS = CommonBlockItemTags.CLUSTERS.item();

	public static final TagKey<Item> VILLAGER_JOB_SITES = CommonBlockItemTags.VILLAGER_JOB_SITES.item();

	// Sands
	public static final TagKey<Item> SANDS = CommonBlockItemTags.SANDS.item();
	public static final TagKey<Item> RED_SANDS = CommonBlockItemTags.RED_SANDS.item();
	public static final TagKey<Item> COLORLESS_SANDS = CommonBlockItemTags.COLORLESS_SANDS.item();

	// Sandstone
	public static final TagKey<Item> SANDSTONE_BLOCKS = CommonBlockItemTags.SANDSTONE_BLOCKS.item();
	public static final TagKey<Item> SANDSTONE_SLABS = CommonBlockItemTags.SANDSTONE_SLABS.item();
	public static final TagKey<Item> SANDSTONE_STAIRS = CommonBlockItemTags.SANDSTONE_STAIRS.item();
	public static final TagKey<Item> RED_SANDSTONE_BLOCKS = CommonBlockItemTags.RED_SANDSTONE_BLOCKS.item();
	public static final TagKey<Item> RED_SANDSTONE_SLABS = CommonBlockItemTags.RED_SANDSTONE_SLABS.item();
	public static final TagKey<Item> RED_SANDSTONE_STAIRS = CommonBlockItemTags.RED_SANDSTONE_STAIRS.item();
	public static final TagKey<Item> UNCOLORED_SANDSTONE_BLOCKS = CommonBlockItemTags.UNCOLORED_SANDSTONE_BLOCKS.item();
	public static final TagKey<Item> UNCOLORED_SANDSTONE_SLABS = CommonBlockItemTags.UNCOLORED_SANDSTONE_SLABS.item();
	public static final TagKey<Item> UNCOLORED_SANDSTONE_STAIRS = CommonBlockItemTags.UNCOLORED_SANDSTONE_STAIRS.item();
	 ...
	 */
	public static final TagKey<Item> SMALL_FLOWERS = CommonBlockItemTags.SMALL_FLOWERS.item();
	/**
	 ...
	 */
	public static final TagKey<Item> TALL_FLOWERS = CommonBlockItemTags.TALL_FLOWERS.item();
	/**
	 ...
	 */
	public static final TagKey<Item> FLOWERS = CommonBlockItemTags.FLOWERS.item();

	// Fences and Fence Gates
	public static final TagKey<Item> FENCES = CommonBlockItemTags.FENCES.item();
	public static final TagKey<Item> WOODEN_FENCES = CommonBlockItemTags.WOODEN_FENCES.item();
	public static final TagKey<Item> NETHER_BRICK_FENCES = CommonBlockItemTags.NETHER_BRICK_FENCES.item();
	public static final TagKey<Item> FENCE_GATES = CommonBlockItemTags.FENCE_GATES.item();
	public static final TagKey<Item> WOODEN_FENCE_GATES = CommonBlockItemTags.WOODEN_FENCE_GATES.item();

	// Bars
	public static final TagKey<Item> BARS = CommonBlockItemTags.BARS.item();
	public static final TagKey<Item> IRON_BARS = CommonBlockItemTags.IRON_BARS.item();
	public static final TagKey<Item> COPPER_BARS = CommonBlockItemTags.COPPER_BARS.item();

	// Pumpkins
	public static final TagKey<Item> PUMPKINS = CommonBlockItemTags.PUMPKINS.item();
	/**
	 * For pumpkins that are not carved.
	 */
	public static final TagKey<Item> NORMAL_PUMPKINS = CommonBlockItemTags.NORMAL_PUMPKINS.item();
	/**
	 * For pumpkins that are already carved but not a light source.
	 */
	public static final TagKey<Item> CARVED_PUMPKINS = CommonBlockItemTags.CARVED_PUMPKINS.item();

	/**
	 * For pumpkins that are already carved and a light source.
	 */
	public static final TagKey<Item> JACK_O_LANTERNS_PUMPKINS = CommonBlockItemTags.JACK_O_LANTERNS_PUMPKINS.item();
	 ...
	 */
	public static final TagKey<Item> DYED = CommonBlockItemTags.DYED.item();
	public static final TagKey<Item> BLACK_DYED = CommonBlockItemTags.BLACK_DYED.item();
	public static final TagKey<Item> BLUE_DYED = CommonBlockItemTags.BLUE_DYED.item();
	public static final TagKey<Item> BROWN_DYED = CommonBlockItemTags.BROWN_DYED.item();
	public static final TagKey<Item> CYAN_DYED = CommonBlockItemTags.CYAN_DYED.item();
	public static final TagKey<Item> GRAY_DYED = CommonBlockItemTags.GRAY_DYED.item();
	public static final TagKey<Item> GREEN_DYED = CommonBlockItemTags.GREEN_DYED.item();
	public static final TagKey<Item> LIGHT_BLUE_DYED = CommonBlockItemTags.LIGHT_BLUE_DYED.item();
	public static final TagKey<Item> LIGHT_GRAY_DYED = CommonBlockItemTags.LIGHT_GRAY_DYED.item();
	public static final TagKey<Item> LIME_DYED = CommonBlockItemTags.LIME_DYED.item();
	public static final TagKey<Item> MAGENTA_DYED = CommonBlockItemTags.MAGENTA_DYED.item();
	public static final TagKey<Item> ORANGE_DYED = CommonBlockItemTags.ORANGE_DYED.item();
	public static final TagKey<Item> PINK_DYED = CommonBlockItemTags.PINK_DYED.item();
	public static final TagKey<Item> PURPLE_DYED = CommonBlockItemTags.PURPLE_DYED.item();
	public static final TagKey<Item> RED_DYED = CommonBlockItemTags.RED_DYED.item();
	public static final TagKey<Item> WHITE_DYED = CommonBlockItemTags.WHITE_DYED.item();
	public static final TagKey<Item> YELLOW_DYED = CommonBlockItemTags.YELLOW_DYED.item();

	/**
	 * Tag that holds items which can be dyed but do not have their own color already, like glass.
	 * (Does not include color blending items like leather armor)
	 */
	public static final TagKey<Item> UNDYED_SIMPLE_DYEABLE = CommonBlockItemTags.UNDYED_SIMPLE_DYEABLE.item();

	/**
	 * Tag that holds items which can be dyed despite already having a color, like wool.
	 * (Does not include color blending items like leather armor)
	 */
	public static final TagKey<Item> REDYEABLE_SIMPLE_DYEABLE = CommonBlockItemTags.REDYEABLE_SIMPLE_DYEABLE.item();
	 ...
	 */
	public static final TagKey<Item> SIMPLE_DYEABLE = CommonBlockItemTags.SIMPLE_DYEABLE.item();
	 ...
	 */
	public static final TagKey<Item> DYNAMIC_DYEABLE = CommonBlockItemTags.DYNAMIC_DYEABLE.item();

	/**
	 * Tag that holds items which can have dye applied to them, whether they have a color already or not.
	 */
	public static final TagKey<Item> DYEABLE = CommonBlockItemTags.DYEABLE.item();
	 ...
	 */
	public static final TagKey<Item> STORAGE_BLOCKS = CommonBlockItemTags.STORAGE_BLOCKS.item();
	public static final TagKey<Item> STORAGE_BLOCKS_BONE_MEAL = CommonBlockItemTags.STORAGE_BLOCKS_BONE_MEAL.item();
	public static final TagKey<Item> STORAGE_BLOCKS_COAL = CommonBlockItemTags.STORAGE_BLOCKS_COAL.item();
	public static final TagKey<Item> STORAGE_BLOCKS_COPPER = CommonBlockItemTags.STORAGE_BLOCKS_COPPER.item();
	public static final TagKey<Item> STORAGE_BLOCKS_DIAMOND = CommonBlockItemTags.STORAGE_BLOCKS_DIAMOND.item();
	public static final TagKey<Item> STORAGE_BLOCKS_DRIED_KELP = CommonBlockItemTags.STORAGE_BLOCKS_DRIED_KELP.item();
	public static final TagKey<Item> STORAGE_BLOCKS_EMERALD = CommonBlockItemTags.STORAGE_BLOCKS_EMERALD.item();
	public static final TagKey<Item> STORAGE_BLOCKS_GOLD = CommonBlockItemTags.STORAGE_BLOCKS_GOLD.item();
	public static final TagKey<Item> STORAGE_BLOCKS_IRON = CommonBlockItemTags.STORAGE_BLOCKS_IRON.item();
	public static final TagKey<Item> STORAGE_BLOCKS_LAPIS = CommonBlockItemTags.STORAGE_BLOCKS_LAPIS.item();
	public static final TagKey<Item> STORAGE_BLOCKS_NETHERITE = CommonBlockItemTags.STORAGE_BLOCKS_NETHERITE.item();
	public static final TagKey<Item> STORAGE_BLOCKS_RAW_COPPER = CommonBlockItemTags.STORAGE_BLOCKS_RAW_COPPER.item();
	public static final TagKey<Item> STORAGE_BLOCKS_RAW_GOLD = CommonBlockItemTags.STORAGE_BLOCKS_RAW_GOLD.item();
	public static final TagKey<Item> STORAGE_BLOCKS_RAW_IRON = CommonBlockItemTags.STORAGE_BLOCKS_RAW_IRON.item();
	public static final TagKey<Item> STORAGE_BLOCKS_REDSTONE = CommonBlockItemTags.STORAGE_BLOCKS_REDSTONE.item();
	public static final TagKey<Item> STORAGE_BLOCKS_RESIN = CommonBlockItemTags.STORAGE_BLOCKS_RESIN.item();
	public static final TagKey<Item> STORAGE_BLOCKS_SLIME = CommonBlockItemTags.STORAGE_BLOCKS_SLIME.item();
	public static final TagKey<Item> STORAGE_BLOCKS_WHEAT = CommonBlockItemTags.STORAGE_BLOCKS_WHEAT.item();

	// Logs
	/**
	 * For logs found naturally in the Overworld, does not include Stripped Logs.
	 */
	public static final TagKey<Item> OVERWORLD_NATURAL_LOGS = CommonBlockItemTags.OVERWORLD_NATURAL_LOGS.item();
	/**
	 * For logs, including Stems, found naturally in the Nether, does not include Stripped Logs.
	 */
	public static final TagKey<Item> NETHER_NATURAL_LOGS = CommonBlockItemTags.NETHER_NATURAL_LOGS.item();
	/**
	 * For logs, including Stems, found naturally that have not been stripped.
	 */
	public static final TagKey<Item> NATURAL_LOGS = CommonBlockItemTags.NATURAL_LOGS.item();
	/**
	 * For six-sided wood blocks, including Hyphae, found naturally that have not been stripped.
	 */
	public static final TagKey<Item> NATURAL_WOODS = CommonBlockItemTags.NATURAL_WOODS.item();
	/**
	 * For logs, including Stems, found naturally that have been stripped.
	 */
	public static final TagKey<Item> STRIPPED_LOGS = CommonBlockItemTags.STRIPPED_LOGS.item();
	/**
	 * For six-sided wood blocks, including Hyphae, found naturally that have been stripped.
	 */
	public static final TagKey<Item> STRIPPED_WOODS = CommonBlockItemTags.STRIPPED_WOODS.item();
	...
	// Other
	public static final TagKey<Item> PLAYER_WORKSTATIONS_CRAFTING_TABLES = CommonBlockItemTags.PLAYER_WORKSTATIONS_CRAFTING_TABLES.item();
	public static final TagKey<Item> PLAYER_WORKSTATIONS_FURNACES = CommonBlockItemTags.PLAYER_WORKSTATIONS_FURNACES.item();
	...
	public static final TagKey<Item> ROPES = CommonBlockItemTags.ROPES.item();
	public static final TagKey<Item> CHAINS = CommonBlockItemTags.CHAINS.item();
	 ...
	 */
	public static final TagKey<Item> HIDDEN_FROM_RECIPE_VIEWERS = CommonBlockItemTags.HIDDEN_FROM_RECIPE_VIEWERS.item();
	 ...
	 */
	public static final TagKey<Item> ORE_BEARING_GROUND_DEEPSLATE = CommonBlockItemTags.ORE_BEARING_GROUND_DEEPSLATE.item();
	/**
	 ...
	 * (The block's registry name is used as the tag name)
	 */
	public static final TagKey<Item> ORE_BEARING_GROUND_NETHERRACK = CommonBlockItemTags.ORE_BEARING_GROUND_NETHERRACK.item();
	/**
	 * Blocks which are often replaced by stone ores, i.e. the ores in the tag {@link #ORES_IN_GROUND_STONE}, during world generation.
	 * (The block's registry name is used as the tag name)
	 */
	public static final TagKey<Item> ORE_BEARING_GROUND_STONE = CommonBlockItemTags.ORE_BEARING_GROUND_STONE.item();
	/**
	 * Ores which on average result in more than one resource worth of materials ignoring fortune and other modifiers.
	 * (example, Copper Ore)
	 */
	public static final TagKey<Item> ORE_RATES_DENSE = CommonBlockItemTags.ORE_RATES_DENSE.item();
	/**
	 * Ores which on average result in one resource worth of materials ignoring fortune and other modifiers.
	 * (Example, Iron Ore)
	 */
	public static final TagKey<Item> ORE_RATES_SINGULAR = CommonBlockItemTags.ORE_RATES_SINGULAR.item();
	/**
	 ...
	 */
	public static final TagKey<Item> ORE_RATES_SPARSE = CommonBlockItemTags.ORE_RATES_SPARSE.item();
	/**
	 ...
	 * (The block's registry name is used as the tag name)
	 */
	public static final TagKey<Item> ORES_IN_GROUND_DEEPSLATE = CommonBlockItemTags.ORES_IN_GROUND_DEEPSLATE.item();
	/**
	 ...
	 * (The block's registry name is used as the tag name)
	 */
	public static final TagKey<Item> ORES_IN_GROUND_NETHERRACK = CommonBlockItemTags.ORES_IN_GROUND_NETHERRACK.item();
	/**
	 ...
	 * (The block's registry name is used as the tag name)
	 */
	public static final TagKey<Item> ORES_IN_GROUND_STONE = CommonBlockItemTags.ORES_IN_GROUND_STONE.item();

	private static TagKey<Item> register(String tagId) {
		return CommonUtils.itemTag("c", tagId);
	}
}